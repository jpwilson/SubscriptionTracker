      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="neu-card p-8 relative border-2 border-purple-500/20"
          >
            ...
            <Link href="/payment?plan=premium" className="block w-full">
              <button className="neu-button w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:shadow-purple-500/25">
                Upgrade to Premium
              </button>
            </Link>
          </motion.div>
          ...
          <motion.div
            ...
            className="neu-card p-8 relative border-2 border-gradient-to-r from-purple-500 to-pink-500"
          >
            <div className="mb-8">
              <h3 className="text-2xl font-bold mb-2 flex items-center gap-2">
                Enterprise
            ...
            <ul className="space-y-4 mb-8">
              {ENTERPRISE_FEATURES.map((feature) => (
                <li key={feature} className="flex items-start gap-3">
                  <div className="p-1 rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 mt-0.5">
            ...
            <Link href="/payment?plan=enterprise" className="block w-full">
              <button className="neu-button w-full border-2 border-purple-500/20 hover:bg-purple-500/10">
                Contact Sales
              </button>
            </Link>
          </motion.div>
