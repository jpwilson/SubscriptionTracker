...
const DEFAULT_CATEGORIES = [
  ...
  { name: 'AI Tools', color: '#EC4899', icon: '🤖' },
  { name: 'SaaS Products', color: '#06B6D4', icon: '☁️' },
  ...
  { name: 'Auto & Transport', color: '#6366F1', icon: '🚗' },
  { name: 'Housing', color: '#84CC16', icon: '🏠' },
  { name: 'Utilities', color: '#FCD34D', icon: '⚡' },
